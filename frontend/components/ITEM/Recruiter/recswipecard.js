      ...
      <View style={styles.screen}>
        <View style={styles.card}>
          <View style={styles.showMessage}>
            <Text style={styles.role}>No candidates are matching</Text>
      ...
      <View style={styles.card}>
        <View style={styles.mainiconContainer}>
          <View style={styles.imageConatiner}>
            <Image
              source={require('../../../assests/prof.png')}
              style={styles.image}
            />
          </View>
          <View style={styles.jobdetails}>
            <Text style={styles.role}>Rahul Yadav</Text>
            <Text style={styles.company}>Role:Web Developer</Text>
        ...
        <View style={styles.description}>
         ...
         Experience: {job.description.minExperience} Years
          </Text>
